...
Event.create(vegetable: carrot, name: '間引き・雑草抜き・害虫駆除', start_date: Date.today + 40.days,
             end_date: Date.today + 90.days, description: '根の成長を助けるために、適切な間引きと雑草管理が必要です。')
...
Event.create(vegetable: tomato, name: '間引き・雑草抜き・害虫駆除', start_date: Date.today + 35.days,
             end_date: Date.today + 95.days, description: 'トマトの苗を健康に保つために、間引きと雑草の抜き取り、害虫の駆除が行われます。')
